...
SERVER_MONITOR = {
    ...
    "TELEGRAM_HEALTH_BUTTON_URL": str(os.getenv("SERVER_MONITOR_TELEGRAM_HEALTH_BUTTON_URL", "")).strip(),
    "TELEGRAM_HEALTH_BUTTON_TEXT": str(os.getenv("SERVER_MONITOR_TELEGRAM_HEALTH_BUTTON_TEXT", "Health")).strip() or "Health",
